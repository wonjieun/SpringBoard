...
<form action="/member/join.do" method="post"
	...
	<div class="form-group">
		<label class="col-xs-2 control-label" for="userpw">패스워드 : </label>
		<div class="col-xs-6">
	...
	<div class="form-group">
		<label class="col-xs-2 control-label" for="usernick">닉네임 : </label>
		<div class="col-xs-6">
			<input type="text" class="form-control" 
				id="usernick" name="usernick" placeholder="닉네임"/>
		</div>
	</div>
